...
/**
 * Class Polynomial - Implements polynomials, and provides polynomial
 * manipulation functions. The polynomials can have any integer coefficients.
 * 
...
public class Polynomial {
         ...
         */
        public void setCoefficient(int r, double value) {
         ...
         *         returned.
         */
        public Polynomial powerOf(double pow) {
    ...
    public String toString() {
        ...
        public static void main(String[] args) {
                ...
                p = p.add(p2);
                System.out.print(p+" divided by "+p2+" is ");
