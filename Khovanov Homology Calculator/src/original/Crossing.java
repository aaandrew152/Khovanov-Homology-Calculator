...
public class Crossing{
    ...
    private boolean positive; //True for positive crossing
    ...
    public int getMaxVertex(){ return Math.max(overstrand[1],understrand[1]); }  //returns max vertex at the crossing
    public int getMinVertex(){ return Math.min(overstrand[0],understrand[0]); }  //returns min vertex at the crossing
    ...
    public void printCrossing(){
    	System.out.println(overstrand[0] + " "+ overstrand[1]+" "+understrand[0]+" "+understrand[1]+" "+positive);
    }
    ...
    public boolean getSign(){ return this.positive;}
    
    public Smoothing getZeroSmoothing(){
        if(this.positive) //if positive crossing
